...
static int isJPGFormat(PT_FileInfo ptFileMap);
static int GetPixelDatasFrmJPG(PT_FileInfo ptFileMap, PT_PixelDatas ptPixelDatas);
static int FreePixelDatasForJPG(PT_PixelDatas ptPixelDatas);

static T_PicFileParser g_tJPGParser = {
	.name           = "jpg",
	.isSuport      = isJPGFormat,
	.GetPicData  = GetPixelDatasFrmJPG,
